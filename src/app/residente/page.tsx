    ...
    <main className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
            <a href={WA_URL} target="_blank" rel="noopener noreferrer"
              onClick={() => trackWA("residente_hero")}
          ...
          <div className="bg-blue-50 rounded-3xl p-10 md:p-14">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <a href={WA_URL} target="_blank" rel="noopener noreferrer"
                  onClick={() => trackWA("residente_funcionalidades")}
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a href={WA_URL} target="_blank" rel="noopener noreferrer"
            onClick={() => trackWA("residente_reservaciones")}
            className="btn-primary px-8 py-4 rounded-xl text-base">
            <WhatsAppIcon />Quiero Eugenia en mi condominio
          </a>
        </div>
      ...
      <section className="py-20 px-6 text-white"
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a href={WA_URL} target="_blank" rel="noopener noreferrer"
            onClick={() => trackWA("residente_cta_final")}
